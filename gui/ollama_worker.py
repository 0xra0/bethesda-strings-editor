...
_TARGET_STYLE: dict[str, str] = {
    ...
    "uk": (
        ...
        "Keep the ти/ви (informal/formal «you») register consistent: choose informal ти "
        "or formal ви to match the source's tone and the speaker's relationship to the "
        "listener, and never mix ти-forms and ви-forms — including the possessives "
        "твій/ваш — when addressing the same person. Keyed dialogue between close "
        "companions and casual NPCs uses ти; officials, strangers, and UI/system prompts "
        "to the player use ви. "
