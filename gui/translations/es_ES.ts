...
Los modelos instalados se detectan automáticamente y la lista se actualiza mientras esta ventana está abierta (por ejemplo, tras «ollama pull»).</translation>
    ...
    <message>
        ...
        <translation>OLLAMA_NUM_PARALLEL (defínalo donde se inicia ollama serve: runit /etc/sv/ollama/run, un drop-in de systemd o su shell, no en esta app) establece las ranuras de GPU concurrentes; ajústelo a los trabajadores paralelos de la app para un rendimiento pleno de dos flujos. Cada ranura reserva una ventana de contexto completa, así que redúzcalo si el modelo se recarga constantemente por desalojo de VRAM; reinicie Ollama tras cambiarlo.</translation>
    </message>
    <message>
        ...
        <translation>En tarjetas AMD ROCm (gfx10xx, RX 6800/6700), defina HSA_ENABLE_SDMA=0 donde se inicia ollama serve para corregir los bloqueos del anillo de GPU cuando los lotes largos se congelan.</translation>
    </message>
    <message>
        ...
        <translation>OLLAMA_KV_CACHE_TYPE=q8_0 junto con OLLAMA_FLASH_ATTENTION=1 reducen a la mitad, aproximadamente, la VRAM de la caché KV del servidor Ollama.</translation>
    </message>
    <message>
